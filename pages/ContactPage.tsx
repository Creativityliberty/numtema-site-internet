      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-20 mb-32">
          ...
          <div className="lg:col-span-5">
             ...
             >
               Boostez votre <span className="text-[#D4AF37]">visibilité</span>
             </motion.h1>
             ...
             <div className="space-y-6">
                <a href={`https://wa.me/${CONFIG.contact.whatsapp}`} className="flex items-center gap-6 p-8 glass rounded-3xl border-[#D4AF37]/30 bg-[#D4AF37]/5 hover:scale-105 transition-all group">
                   <div className="w-14 h-14 rounded-2xl bg-[#D4AF37] flex items-center justify-center text-white shadow-lg"><MessageSquare size={28} /></div>
                   <div>
          ...
          <div className="lg:col-span-7">
             ...
             >
                ...
                <form className="space-y-6" onSubmit={handleSubmit}>
                   <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                         ...
                         <input
                           ...
                           className="w-full glass border-white/10 rounded-2xl py-5 px-8 outline-none focus:border-[#D4AF37]/50 transition-all font-bold"
                   ...
                   <button type="submit" className="w-full py-6 bg-[#D4AF37] text-white rounded-2xl font-black text-lg uppercase tracking-widest flex items-center justify-center gap-4 hover:bg-white hover:text-black transition-all shadow-2xl shadow-[#D4AF37]/20">
           ...
           <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {engagements.map((item, i) => (
                <motion.div
                  ...
                  className="p-10 glass rounded-[3rem] border-white/5 hover:border-[#D4AF37]/20 transition-all group"
                >
                   <div className="w-14 h-14 bg-[#D4AF37]/10 rounded-2xl flex items-center justify-center text-[#D4AF37] mb-8 group-hover:scale-110 transition-transform">
                      <item.icon size={30} />
                   </div>
        ...
        {/* Final CTA */}
        <div className="mt-32 p-16 rounded-[4rem] glass border-dashed border-[#D4AF37]/40 text-center relative overflow-hidden">
           <div className="absolute inset-0 bg-[#D4AF37]/5 -z-10 blur-3xl"></div>
           ...
           <a
              ...
              className="inline-flex px-12 py-6 bg-[#D4AF37] text-white rounded-2xl font-black text-sm uppercase tracking-widest hover:scale-105 transition-all shadow-xl shadow-[#D4AF37]/20"
           >
