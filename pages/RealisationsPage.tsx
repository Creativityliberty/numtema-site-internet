    ...
    <div className="pt-40">
       ...
       <div className="py-40 px-6 max-w-7xl mx-auto">
          <div className="p-16 rounded-[4rem] glass border-[#D4AF37]/20 bg-[#D4AF37]/5 flex flex-col items-center text-center">
             ...
             <a href="#/contact" className="bg-[#D4AF37] text-white px-16 py-6 rounded-2xl font-black text-xl uppercase tracking-widest hover:scale-105 transition-all shadow-2xl shadow-[#D4AF37]/20">
                Lancer mon projet
             </a>
          </div>
       </div>
