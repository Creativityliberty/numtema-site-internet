      ...
      <div className="max-w-7xl mx-auto">
          ...
          {CONFIG.formations.map((f, i) => (
            ...
            >
              ...
              <a
                ...
                className="w-full py-5 rounded-2xl bg-[#D4AF37] text-white font-black text-xs uppercase tracking-widest text-center flex items-center justify-center gap-3 hover:bg-white hover:text-black transition-all shadow-xl shadow-[#D4AF37]/10"
              >
        ...
        <div className="mt-32 p-16 rounded-[4rem] glass border-dashed border-[#D4AF37]/40 text-center">
           ...
           <button 
              ...
              className="px-12 py-6 glass rounded-2xl font-black text-sm uppercase tracking-widest hover:border-[#D4AF37] transition-all border-white/10"
           >
              Discutons-en
           </button>
        </div>
